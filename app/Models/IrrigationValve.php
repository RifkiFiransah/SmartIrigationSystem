...
class IrrigationValve extends Model
{
    ...
    public function open(?int $maxDurationMinutes = null): void
    {
        $this->status = 'open';
        $this->last_open_at = now();
        $this->save();
        $this->recordLog('open', 'manual', $maxDurationMinutes);
    }
    ...
    public function toggleMode(): void
    {
        ...
        $this->save();
        $this->recordLog('toggle_mode', 'manual');
    }
